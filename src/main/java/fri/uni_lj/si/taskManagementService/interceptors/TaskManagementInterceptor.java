package fri.uni_lj.si.taskManagementService.interceptors;
...
@Component
public class TaskManagementInterceptor implements HandlerInterceptor {

    private static final Logger logger = LoggerFactory.getLogger(TaskManagementInterceptor.class);
