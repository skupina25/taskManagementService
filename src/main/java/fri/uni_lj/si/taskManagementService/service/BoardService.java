...
public class BoardService {
    ...
    public Board addBoard(Board newBoard) {
        ...
        if(board.getTeamId() != null) {
            ...
            final String uri = "http://host.docker.internal:8082/api/v1/team/{teamId}/boards";
        ...
        if(board.isPresent()) {
           ...
           if(newBoard.getTitle() != null) {
            ...
            if(newBoard.getTeamId() != null) {
                ...
                final String uri = "http://host.docker.internal:8082/api/v1/team/{teamId}/boards/{boardId}";
                RestTemplate restTemplate = new RestTemplate();
